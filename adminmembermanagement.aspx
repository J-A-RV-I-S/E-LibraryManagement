               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <asp:Button class="btn btn-lg btn-danger btn-block" ID="Button2" runat="server" Text="Delete User Permenantly" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="member_id" AutoGenerateColumns="False">
                           <Columns>
                              <asp:BoundField HeaderText="ID" DataField="member_id"></asp:BoundField>
                              <asp:BoundField HeaderText="Name" DataField="full_name"></asp:BoundField>
                              <asp:BoundField HeaderText="Account Status" DataField="account_status"></asp:BoundField>
                              <asp:BoundField HeaderText="Contact" DataField="contact_no"></asp:BoundField>
